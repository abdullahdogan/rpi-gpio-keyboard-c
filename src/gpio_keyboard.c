...
/* ===================== USER MAPPING ===================== */
static map_t MAPS[] = {
    {16,  KEY_ENTER, {0}, 0, "GPIO16->ENTER", 0, 0, 0, 0, 0, 0},
    {4, KEY_ESC,   {0}, 0, "GPIO4->ESC",  0, 0, 0, 0, 0, 0},
    {6, KEY_UP,    {0}, 0, "GPIO6->UP",   0, 0, 0, 0, 0, 0},
    {7,  KEY_DOWN,  {0}, 0, "GPIO7->DOWN",  0, 0, 0, 0, 0, 0},
    {17,  KEY_LEFT,  {0}, 0, "GPIO17->LEFT",  0, 0, 0, 0, 0, 0},
    {5,  KEY_RIGHT, {0}, 0, "GPIO5->RIGHT", 0, 0, 0, 0, 0, 0},
};
/* ========================================================= */
